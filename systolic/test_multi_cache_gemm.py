...
def top(
    ...
    L3_A: Stream[UInt(Rt * 8), 64]
    L3_B: Stream[UInt(Ct * 8), 64]
    L3_C: Stream[UInt(Rt * 8), 64]

    L2_A: Stream[UInt(Rt * 8), 64][P0 - 1]
    L2_B: Stream[UInt(Ct * 8), 64][P1 - 1]

    L1_C: Stream[UInt(Rt * 8), 64][Rt, Ct]
    L2_C: Stream[UInt(Rt * 8), 64][Ct]

    fifo_A: Stream[int8, 64][Rt, Ct]
    fifo_B: Stream[int8, 64][Rt, Ct]
